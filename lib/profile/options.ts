...
export const COOKING_LEVELS = [
  { value: "iniciante", label: "Iniciante", desc: "Preciso de receitas simples e rápidas", emoji: "👶" },
  { value: "intermediario", label: "Intermediário", desc: "Consigo seguir receitas normalmente", emoji: "👨‍🍳" },
  { value: "avancado", label: "Avançado", desc: "Adoro desafios na cozinha", emoji: "⭐" },
] as const;
